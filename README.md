...
Adicione a sua chave de API (conforme esperado pela biblioteca google-genai):
...
Vá até ao endpoint POST /classificar.

Clique em "Try it out" e envie uma mensagem.
